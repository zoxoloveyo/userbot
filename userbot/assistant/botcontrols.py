...
@jmthon.ar_cmd(
    ...
    info={
        "header": "لمعرفة الأشخاص الذين قاموا بتشغيل بوتك ",
        "description": "للحصول على قائمة للأشخاص الذين استخدموا بوتك",
        "usage": "المستخدمين",
    },
)
...
@jmthon.ar_cmd(
    ...
    info={
        "header": "لمعرفة الأشخاص المحظورين من بوتك.",
        "description": "للحصول على قائمة الأشخاص المحظورين في بوتك ",
        "usage": "المحظورين",
    },
)
async def ban_starters(event):
